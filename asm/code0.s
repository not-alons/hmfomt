...
sub_809B32C: @ 0x0809B32C
	...
	thumb_func_start sub_809B350
sub_809B350: @ 0x0809B350
	push {r4, lr}
	adds r4, r0, #0
	bl sub_809B1A4
	movs r0, #0
	...
	thumb_func_start sub_809B374
sub_809B374: @ 0x0809B374
	ldrb r0, [r0, #0x1c]
	bx lr
_0809B378:
	.byte 0x40, 0x7F, 0xC0, 0x07, 0xC0, 0x0F, 0x70, 0x47
	.byte 0x40, 0x7F, 0x80, 0x07, 0xC0, 0x0F, 0x70, 0x47
...
_0809B39E:
	...
	bx r0
_0809B3A4:
	.byte 0x00, 0xB5, 0x49, 0x42, 0xFF, 0xF7, 0xEE, 0xFF, 0x01, 0xBC, 0x00, 0x47

	thumb_func_start sub_809B3B0
sub_809B3B0: @ 0x0809B3B0
	ldrb r1, [r0, #0x1d]
	movs r2, #1
	orrs r1, r2
	strb r1, [r0, #0x1d]
	...
	thumb_func_start sub_809B3BC
sub_809B3BC: @ 0x0809B3BC
	ldrb r1, [r0, #0x1d]
	movs r2, #2
	orrs r1, r2
	strb r1, [r0, #0x1d]
	...
	thumb_func_start sub_809B3C8
sub_809B3C8: @ 0x0809B3C8
	push {r4, r5, r6, r7, lr}
	adds r5, r0, #0
	lsls r4, r1, #0x18
	lsrs r4, r4, #0x18
...
_0809B44C:
	...
	thumb_func_start sub_809B454
sub_809B454: @ 0x0809B454 Chicken, Cow, Sheep Init
	push {r4, r5, lr}
	adds r4, r0, #0
	ldr r5, [sp, #0xc]
	bl sub_809B12C
	...
	bx r1
	.align 2, 0
_0809B4A0: .4byte 0xFFFFFE00

	thumb_func_start sub_809B4A4
sub_809B4A4: @ 0x0809B4A4
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r5, r3, #0
	bl sub_809B1A4
	...
	bx r1
	.align 2, 0
_0809B4F0: .4byte 0xFFFFFE00

	thumb_func_start sub_809B4F4
sub_809B4F4: @ 0x0809B4F4
	ldrb r0, [r0, #0x1c]
	lsls r0, r0, #0x1b
	lsrs r0, r0, #0x1b
	bx lr

	thumb_func_start sub_809B4FC
sub_809B4FC: @ 0x0809B4FC
	ldrb r0, [r0, #0x1c]
	lsls r0, r0, #0x1a
	lsrs r0, r0, #0x1f
	bx lr
...
sub_809B504: @ 0x0809B504
	...
	thumb_func_start sub_809B50C
sub_809B50C: @ 0x0809B50C
	ldrb r0, [r0, #0x1c]
	lsrs r0, r0, #7
	bx lr
	.align 2, 0

	thumb_func_start sub_809B514
sub_809B514: @ 0x0809B514
	ldrb r0, [r0, #0x1d]
	lsls r0, r0, #0x1e
	lsrs r0, r0, #0x1e
	bx lr

	thumb_func_start sub_809B51C
sub_809B51C: @ 0x0809B51C
	ldrh r0, [r0, #0x1e]
	lsls r0, r0, #0x17
	lsrs r0, r0, #0x17
	bx lr

	thumb_func_start sub_809B524
sub_809B524: @ 0x0809B524
	ldrb r2, [r0, #0x1f]
	lsrs r2, r2, #1
	ldrh r0, [r0, #0x20]
	ldr r1, _0809B534 @ =0x000001FF
	ands r0, r1
	lsls r0, r0, #7
	orrs r0, r2
	bx lr
	.align 2, 0
_0809B534: .4byte 0x000001FF
...
_0809B550:
	...
	adds r0, r4, #0
	bl sub_809B524
	ldr r1, _0809B56C @ =0x00008C9F
	cmp r0, r1
	bls _0809B570
	movs r0, #4
	b _0809B576
	.align 2, 0
_0809B56C: .4byte 0x00008C9F
_0809B570:
	movs r0, #3
	b _0809B576
_0809B574:
...
_0809B5B0:
	...
	lsrs r0, r5, #1
	ldrh r1, [r4, #0x20]
	ldr r7, _0809B5FC @ =0x000001FF
	ands r1, r7
	lsls r1, r1, #7
	orrs r1, r0
	ldr r0, _0809B604 @ =0x0000FFFE
	cmp r1, r0
	bhi _0809B5F4
	adds r1, r1, r6
	str r1, [sp, #8]
...
_0809B5F4:
	...
	bx r0
	.align 2, 0
_0809B5FC: .4byte 0x000001FF
_0809B600: .4byte 0xFFFFFE00
_0809B604: .4byte 0x0000FFFE

	thumb_func_start sub_809B608
sub_809B608: @ 0x0809B608
	ldrh r2, [r0, #0x1e]
	ldr r1, _0809B614 @ =0xFFFFFE00
	ands r1, r2
	strh r1, [r0, #0x1e]
	bx lr
	.align 2, 0
_0809B614: .4byte 0xFFFFFE00
_0809B618:
	.byte 0x01, 0x7F, 0x80, 0x22, 0x11, 0x43, 0x01, 0x77
	.byte 0x70, 0x47, 0x00, 0x00

	thumb_func_start sub_809B624
sub_809B624: @ 0x0809B624
	ldrb r2, [r0, #0x1c]
	movs r1, #0x7f
	ands r1, r2
	strb r1, [r0, #0x1c]
...
sub_809B638: @ 0x0809B638
	...
	thumb_func_start sub_809B644
sub_809B644: @ 0x0809B644
	ldrb r2, [r0, #0x1c]
	movs r1, #0x41
	rsbs r1, r1, #0
	ands r1, r2
	...
	thumb_func_start sub_809B65C
sub_809B65C: @ 0x0809B65C
	push {lr}
	adds r2, r0, #0
	ldrb r1, [r2, #0x1c]
	lsls r0, r1, #0x1a
...
_0809B80E:
	...
	thumb_func_start sub_809B828
sub_809B828: @ 0x0809B828 Init Cow?
	push {r4, lr}
	sub sp, #4
	adds r4, r0, #0
	ldr r0, [sp, #0xc]
	...
	bx r1
	.align 2, 0
_0809B86C: .4byte 0xFFFFF83F

	thumb_func_start sub_809B870
sub_809B870: @ 0x0809B870
	push {r4, lr}
	adds r4, r0, #0
	bl sub_809B4A4
	adds r2, r4, #0
	...
	bx r1
	.align 2, 0
_0809B8AC: .4byte 0xFFFFF83F

	thumb_func_start sub_809B8B0
sub_809B8B0: @ 0x0809B8B0
	adds r0, #0x24
	ldrb r0, [r0]
	lsls r0, r0, #0x1f
	lsrs r0, r0, #0x1f
	...
	thumb_func_start sub_809B8BC
sub_809B8BC: @ 0x0809B8BC
	push {lr}
	adds r0, #0x24
	ldrb r1, [r0]
	lsls r0, r1, #0x1f
...
_0809B8D0:
	...
	thumb_func_start sub_809B8D4
sub_809B8D4: @ 0x0809B8D4
	push {lr}
	adds r1, r0, #0
	adds r0, #0x24
	ldrb r0, [r0]
...
_0809B8EC:
	...
	thumb_func_start sub_809B8F0
sub_809B8F0: @ 0x0809B8F0
	push {lr}
	bl sub_809B65C
	pop {r0}
	bx r0
...
sub_809B8FC: @ 0x0809B8FC
	...
	strb r1, [r3]
	ldrh r2, [r0, #0x24]
	ldr r1, _0809B918 @ =0xFFFFF83F
	ands r1, r2
	strh r1, [r0, #0x24]
	bx lr
	.align 2, 0
_0809B918: .4byte 0xFFFFF83F

	thumb_func_start sub_809B91C
sub_809B91C: @ 0x0809B91C
	adds r3, r0, #0
	adds r3, #0x24
	ldrb r2, [r3]
	movs r1, #2
	...
	strb r1, [r3]
	ldrh r2, [r0, #0x24]
	ldr r1, _0809B93C @ =0xFFFFF83F
	ands r1, r2
	strh r1, [r0, #0x24]
	bx lr
	.align 2, 0
_0809B93C: .4byte 0xFFFFF83F

	thumb_func_start sub_809B940
sub_809B940: @ 0x0809B940
	ldr r1, [r1]
	str r1, [r0, #0x2c]
	movs r1, #0
	str r1, [r0, #0x28]
	...
	thumb_func_start sub_809B94C
sub_809B94C: @ 0x0809B94C
	ldr r1, [r1]
	str r1, [r0, #0x2c]
	movs r1, #1
	str r1, [r0, #0x28]
	...
	thumb_func_start sub_809B958
sub_809B958: @ 0x0809B958
	ldr r2, [r1, #4]
	ldr r1, [r1]
	str r1, [r0, #0x2c]
	str r2, [r0, #0x30]
...
_0809BB42:
	...
	thumb_func_start sub_809BB48
sub_809BB48: @ 0x0809BB48
	ldr r1, [r1]
	str r1, [r0, #0x24]
	movs r1, #0
	str r1, [r0, #0x20]
	...
	thumb_func_start sub_809BB54
sub_809BB54: @ 0x0809BB54
	ldr r2, [r1, #4]
	ldr r1, [r1]
	str r1, [r0, #0x24]
	str r2, [r0, #0x28]
	...
	thumb_func_start sub_809BB64
sub_809BB64: @ 0x0809BB64
	ldr r1, [r1]
	str r1, [r0, #0x24]
	movs r1, #2
	str r1, [r0, #0x20]
	...
	thumb_func_start sub_809BB70
sub_809BB70: @ 0x0809BB70
	ldr r2, [r1, #4]
	ldr r1, [r1]
	str r1, [r0, #0x24]
	str r2, [r0, #0x28]
	...
	thumb_func_start sub_809BB80
sub_809BB80: @ 0x0809BB80
	ldr r1, [r1]
	str r1, [r0, #0x24]
	movs r1, #4
	str r1, [r0, #0x20]
	...
	thumb_func_start sub_809BB8C
sub_809BB8C: @ 0x0809BB8C
	ldr r2, [r1, #4]
	ldr r1, [r1]
	str r1, [r0, #0x24]
	str r2, [r0, #0x28]
	...
	thumb_func_start sub_809BB9C
sub_809BB9C: @ 0x0809BB9C
	ldr r1, [r1]
	str r1, [r0, #0x24]
	movs r1, #6
	str r1, [r0, #0x20]
	...
	thumb_func_start sub_809BBA8
sub_809BBA8: @ 0x0809BBA8
	push {r4, lr}
	adds r4, r0, #0
	adds r4, #0x2d
	ldrb r1, [r4]
	...
	.align 2, 0
_0809BBD0:
	.byte 0x10, 0xB5, 0x04, 0x1C, 0xFF, 0xF7, 0xAA, 0xFB, 0x00, 0x20, 0x20, 0x62, 0x00, 0x21, 0xA0, 0x84
	.byte 0x20, 0x1C, 0x26, 0x30, 0x01, 0x70, 0x20, 0x1C, 0x10, 0xBC, 0x02, 0xBC, 0x08, 0x47, 0x00, 0x00

	thumb_func_start sub_809BBF0
sub_809BBF0: @ 0x0809BBF0 Init Horse?
	push {r4, lr}
	adds r4, r0, #0
	bl sub_809B350
	movs r0, #0
	...
	thumb_func_start sub_809BC10
sub_809BC10: @ 0x0809BC10
	push {lr}
	bl sub_809B220
	movs r1, #0
	cmp r0, #0x77
...
_0809BC1E:
	...
	thumb_func_start sub_809BC24
sub_809BC24: @ 0x0809BC24
	ldr r1, [r1]
	str r1, [r0, #0x24]
	movs r1, #0
	str r1, [r0, #0x20]
	...
	thumb_func_start sub_809BC30
sub_809BC30: @ 0x0809BC30
	ldr r2, [r1, #4]
	ldr r1, [r1]
	str r1, [r0, #0x24]
	str r2, [r0, #0x28]
	...
	thumb_func_start sub_809BC40
sub_809BC40: @ 0x0809BC40
	movs r1, #2
	str r1, [r0, #0x20]
	bx lr
	.align 2, 0

	thumb_func_start sub_809BC48
sub_809BC48: @ 0x0809BC48
	push {r4, lr}
	adds r4, r0, #0
	movs r1, #0
	bl sub_809B3C8
...
sub_809BC64: @ 0x0809BC64 Init Chicken?
	push {r4, lr}
	sub sp, #4
	adds r4, r0, #0
	ldr r0, [sp, #0xc]
...
sub_809BE94: @ 0x0809BE94 Init Sheep?
	push {r4, lr}
	sub sp, #4
	adds r4, r0, #0
	ldr r0, [sp, #0xc]
