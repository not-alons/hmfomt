	...
	thumb_func_start sub_800B660
sub_800B660: @ 0x0800B660
	push {r4, r5, r6, r7, lr}
	adds r6, r0, #0
	adds r4, r6, #0
	movs r5, #0x3f
...
_0800B66C:
	...
	.align 2, 0
_0800B684:
	.byte 0x89, 0x00, 0x40, 0x18, 0x70, 0x47, 0x00, 0x00

	thumb_func_start sub_800B68C
sub_800B68C: @ 0x0800B68C
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	adds r7, r1, #0
	movs r5, #0
...
_0800B730:
	...
	.align 2, 0
_0800B73C:
	.byte 0x70, 0xB5, 0x00, 0x26
	.byte 0x80, 0x21, 0x49, 0x00, 0x45, 0x18, 0x04, 0x1C, 0xAC, 0x42, 0x0B, 0xD0, 0x20, 0x1C, 0x02, 0xF0
	.byte 0xC5, 0xFB, 0x00, 0x06, 0x00, 0x28, 0x01, 0xD0, 0x30, 0x1C, 0x05, 0xE0, 0x04, 0x34, 0x01, 0x36
	.byte 0xAC, 0x42, 0xF3, 0xD1, 0x01, 0x20, 0x40, 0x42, 0x70, 0xBC, 0x02, 0xBC, 0x08, 0x47, 0x00, 0x00
	...
	thumb_func_start sub_800B7B8
sub_800B7B8: @ 0x0800B7B8
	push {r4, r5, r6, r7, lr}
	sub sp, #4
	adds r7, r1, #0
	movs r6, #0
...
sub_800B80C: @ 0x0800B80C
	...
	thumb_func_start sub_800B814
sub_800B814: @ 0x0800B814
	push {r4, r5, r6, r7, lr}
	mov r7, r8
	push {r7}
	sub sp, #0x14
...
_0800B8D8:
	...
	thumb_func_start sub_800B8E4
sub_800B8E4: @ 0x0800B8E4
	push {r4, r5, r6, r7, lr}
	adds r6, r0, #0
	adds r4, r6, #0
	movs r5, #0x3f
...
_0800B9C0:
	...
	.align 2, 0
_0800B9D0:
	.byte 0x70, 0xB5, 0x00, 0x26, 0x05, 0x1C, 0x80, 0x35, 0x04, 0x1C, 0xAC, 0x42, 0x0B, 0xD0, 0x20, 0x1C
	.byte 0x02, 0xF0, 0x4C, 0xFB, 0x00, 0x06, 0x00, 0x28, 0x01, 0xD0, 0x30, 0x1C, 0x05, 0xE0, 0x02, 0x34
	.byte 0x01, 0x36, 0xAC, 0x42, 0xF3, 0xD1, 0x01, 0x20, 0x40, 0x42, 0x70, 0xBC, 0x02, 0xBC, 0x08, 0x47
...
_0800BA92:
	...
	thumb_func_start sub_800BAA0
sub_800BAA0: @ 0x0800BAA0
	lsls r1, r1, #1
	adds r0, r0, r1
	bx lr
	.align 2, 0
